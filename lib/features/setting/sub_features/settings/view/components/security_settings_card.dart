...
class SecuritySettingsCard extends GetView<SettingsController> {
          ...
          Obx(() => Column(
                children: [
                  _buildSecurityItem(
                    ...
                    value: controller.securitySettings.biometric,
                    onChanged: () =>
                        controller.toggleSecuritySetting('biometric'),
                  ),
                  SizedBox(height: 16.h),
                  _buildSecurityItem(
                    title: 'Auto Lock',
                    subtitle: 'Automatically lock app when idle',
                    value: controller.securitySettings.autoLock,
                    onChanged: () =>
                        controller.toggleSecuritySetting('autoLock'),
                  ),
                  SizedBox(height: 16.h),
                  _buildSecurityItem(
                    title: 'Login Notifications',
                    subtitle: 'Get notified of new login attempts',
                    value: controller.securitySettings.loginNotifications,
                    onChanged: () =>
                        controller.toggleSecuritySetting('loginNotifications'),
                  ),
                ],
              )),
        ],
